...
[3:15 PM]Veritas
: in my experience we should keep the VM speed that correspond to the Console/PC
10 Ms.(def) 
8 Ms.XBOX ONE 
4 Ms. PS4/PS5 
2 Ms. XBOX X/S
...
[3:41 PM]Veritas
: So for XBOX X/S we are ok with 2ms?
...
[4:42 PM]тαуℓσя∂яιƒт21
: Ah see I didn't notice on the 2ms bro - I only noticed a big difference on the 1ms . 
...
[4:49 PM]тαуℓσя∂яιƒт21
: I also noticed a while back the get_ptime() is also out a loop - not sure if you came across that
[4:50 PM]тαуℓσя∂яιƒт21
: Say you want to do something at 300ms - it would actually return at 290ms 
...
Fadexz
: Technically this is the fastest you can do on PS4/PS5, assuming you are limited by 4ms intervals. On PC technically you can use a driver to change the polling rate to 1ms (1000hz)
define SPAM_MS = 4;
define FIRE = PS4_L2;
...
docs about it: https://guide.cronus.support/gpc/MnBy-gpc-scripting-device-functions